...
-	**Attributes:** allowedBlocks, alt, backgroundType, contentPosition, customGradient, customOverlayColor, dimRatio, focalPoint, gradient, hasParallax, id, isDark, isRepeated, isUserOverlayColor, minHeight, minHeightUnit, overflow, overflowX, overflowY, overlayColor, sizeSlug, tagName, templateLock, url, useFeaturedImage
